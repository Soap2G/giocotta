...
const shuffleditems = shuffleArray(imageArray());
    ...
    >
      ...
      <div className="case" style= {{ marginTop: "1em" }} >
          ...
          <code style={{ wordWrap: "break-word" }}>Elisa Cottafava<br/>IBAN:IT18B0538712900000003066747<br/>- - -<br/>Giovanni Guerrieri<br/>IBAN:IT20A0301503200000003632172</code><br/><br/>
