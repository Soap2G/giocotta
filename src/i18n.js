...
const resources = {
  en: {
    translation: {
      ...
      "IBAN": "We're excited for your presence, not presents.<br/> However, we asked <a>Mr. Dondi, in Str. Formigina, 254, 41126 Modena MO</a>, to guide us in finding a bit of kitchenware, should you decide to help us.",
      "IBAN2": "Alternatively, we appreciate a contribution made to:",
      ...
      "rsvp": "Get in touch",
      "rsvp1": "We appreciate your RSVP by April 30th, 2024.",
      "fullName": "Your name",
      "email": "Your email",
  ...
  it: {
    translation: {
        ...
        "IBAN": "Molto di quello che ci serve lo abbiamo già, ma se avete piacere di contribuire, <br/> abbiamo chiesto al <a>Sig. Dondi in Str. Formigina, 254, 41126 Modena MO</a> di tenerci da parte alcune pentole.",
        "IBAN2": "Alternativamente, attraverso queste coordinate:",
        ...
        "rsvp1": "Conferma gradita entro il 30 Aprile 2024.",
